		...
		{
			{
				...
				ports={{0, 0.5},{1, 0.5},{2, 0.241},{2, 0.759}}
			},
			{
				verts={{0, 19.319},{5.176, 0},{0, -19.319}},
				ports={{0, 0.25},{0, 0.75},{1, 0.25},{1, 0.75},{2, 0.112},{2, 0.371},{2, 0.629},{2, 0.888}}
			},
			{
				verts={{0, 28.978},{7.765, 0},{0, -28.978}},
				ports={{0, 0.167},{0, 0.5},{0, 0.833},{1, 0.167},{1, 0.5},{1, 0.833},{2, 0.069},{2, 0.241},{2, 0.413},{2, 0.586},{2, 0.759},{2, 0.931}}
			},
		}
	},
