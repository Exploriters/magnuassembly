		...
		{
			{
				...
				ports={{0, 0.5}, {1, 0.5}, {2, 0.5}, {3, 0.5, LAUNCHER}, {5, 0.5}, {6, 0.5}, {7, 0.5}}
			},
			{
				verts={{0, -20}, {-17.321, -10}, {-17.321, 10}, {0, 20}, {0, -20}, {0, 20}, {17.321, 10}, {17.321, -10}},
				ports={{0, 0.25}, {0, 0.75}, {1, 0.25}, {1, 0.75}, {2, 0.25}, {3, 0.5, LAUNCHER}, {2, 0.75}, {4, 0.25}, {4, 0.75}, {5,0.25}, {5, 0.75}, {6, 0.25}, {6, 0.75}, {7, 0.25}, {7, 0.75}}
			},
			{
				verts={{0, -30}, {-25.981, -15}, {-25.981, 15}, {0, 30}, {0, -30}, {0, 30}, {25.981, 15}, {25.981, -15}},
				ports={{0, 0.167}, {0, 0.5}, {0, 0.833}, {1, 0.167}, {1, 0.5}, {1, 0.833}, {2, 0.167}, {2, 0.5}, {2, 0.833}, {3, 0.5, LAUNCHER}, {4, 0.167}, {4, 0.5}, {4, 0.833}, {5, 0.167}, {5, 0.5}, {5, 0.833}, {6, 0.167}, {6, 0.5}, {6, 0.833}, {7, 0.167}, {7, 0.5}, {7, 0.833}}
			},
		},
		launcher_radial=true
	}
