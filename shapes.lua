	...
	-- TRI_HEAD_LAUNCHER 正三角形尖发射器
	{
		1257065,
		{
			...
			},
			{
				...
				ports={{0, 0.25,LAUNCHER},{0, 0.75},{2, 0.25},{2, 0.75},{4, 0.25},{4, 0.75}}
			},
			{
				verts={{25.981, 0},{25.981, -0.001},{0, -15},{0, -15},{0, 15},{0, 15}},
				ports={{0, 0.167,LAUNCHER},{0, 0.5},{0, 0.833},{2, 0.167},{2, 0.5},{2, 0.833},{4, 0.168},{4, 0.5},{4,0.833}}
			},
		},
		launcher_radial=true,
	},
	
	-- HEXAGON_MID_ROOT 六边形夹层种子发射器
	{
		1257066,
		{
			{
