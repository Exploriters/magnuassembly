...
--
	...
	-- OUTLAW_THRUSTER_PRIMARY_RAA 狂徒族主推进器 RAA
	{
		...
		{
			{
				verts={{0,0},{0,5},{2.5,5},{4.999,2.5},{5.001,2.5},{7.5,5},{9.5,5},{10,4.5},{10,2.5},{7.5,0.001},{7.5,-0.001},{10,-2.5},{10,-4.5},{9.5,-5},{7.5,-5},{5.001,-2.5},{4.999,-2.5},{2.5,-5},{0,-5},{0,0},{0,-5},{-2.5,-5},{-4.999,-2.5},{-5.001,-2.5},{-7.5,-5},{-9.5,-5},{-10,-4.5},{-10,4.5},{-9.5,5},{-7.5,5},{-5.001,2.5},{-4.999,2.5},{-2.5,5},{-0,5}},
				ports={{0,0,THRUSTER_OUT},{3,0.5,THRUSTER_OUT},{16,0.5,THRUSTER_OUT},{23,0.5,THRUSTER_OUT},{31,0.5,THRUSTER_OUT}
					{1,0},{14,1}
				}
			},
		},
