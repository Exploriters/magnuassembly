...
--
	-- SQUARE_COMMAND_3883 战略狂欢者核心
	{
		1257020,
		{
			{
				verts={{5, -5},{-5, -5},{-5, 5},{5, 5}},
				ports={{0, 0.5, NORMAL|THRUSTER_OUT},{1, 0.5, NORMAL|THRUSTER_OUT},{1, 0.5, NORMAL|THRUSTER_OUT},{2, 0.5, NORMAL|THRUSTER_OUT},{3, 0.5, NORMAL|THRUSTER_OUT|WEAPON_OUT}}
			},
			{
				verts={{10, -10}, {-10, -10}, {-10, 10}, {10, 10}},
				ports={{3, 0.25, NORMAL|THRUSTER_OUT|WEAPON_OUT},{3, 0.75, NORMAL|THRUSTER_OUT|WEAPON_OUT},{0, 0.25, NORMAL|THRUSTER_OUT},{0, 0.75, NORMAL|THRUSTER_OUT},{1, 0.25, NORMAL|THRUSTER_OUT},{1, 0.75, NORMAL|THRUSTER_OUT},{2, 0.25, NORMAL|THRUSTER_OUT},{2, 0.75, NORMAL|THRUSTER_OUT}}
			},
			{
				verts={{15, -15}, {-15, -15}, {-15, 15}, {15, 15}},
				ports={
					{1, 0.167, NORMAL|THRUSTER_OUT}, {1, 0.5, NORMAL|THRUSTER_OUT}, {1, 0.833, NORMAL|THRUSTER_OUT},
					{3, 0.167, NORMAL|THRUSTER_OUT|WEAPON_OUT}, {3, 0.5, NORMAL|THRUSTER_OUT|WEAPON_OUT}, {3, 0.833, NORMAL|THRUSTER_OUT|WEAPON_OUT},
					{0,0.167, NORMAL|THRUSTER_OUT}, {0, 0.5, NORMAL|THRUSTER_OUT}, {0, 0.833, NORMAL|THRUSTER_OUT},
					{2, 0.167, NORMAL|THRUSTER_OUT}, {2, 0.5, NORMAL|THRUSTER_OUT}, {2,0.833, NORMAL|THRUSTER_OUT}
				}
			},
		}
	},
