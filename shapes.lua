...
--
	...
	-- THOMBUS_MID_MISSILE 光明护卫夹层导弹
	{
		...
		{
			{
				verts={{0, 5},{8.660, 0},{0, -5},{0, 5},{0, -5},{-8.660, 0},{0, 5}},
				ports={{2, 0.5, MISSILE}}
			},
			{
				verts={{0, 10},{17.321, 0},{0, -10},{0, 10},{0, -10},{-17.321, 0},{0, 10}},
				ports={{2, 0.5, MISSILE}}
			},
			{
				verts={{0, 15},{25.981, 0},{0, -15},{0, 15},{0, -15},{-25.981, 0},{0, 15}},
				ports={{2, 0.5, MISSILE}}
			},
		}
	},
...
--
	-- RECT_MID_LAUNCHER 光明护卫夹层导弹发射器
	{
		1257047,
		{
			...
			{--9
				verts={{0, -45}, {-5, -45}, {-5, 45}, {0, 45}, {0, -45}, {0, 45}, {5, 45}, {5, -45}, {0, -45}},
				ports={{0, 1}, {2, 0}, {5, 1}, {7, 0},
			...
			{--10
				verts={{0, -50}, {-5, -50}, {-5, 50}, {0, 50}, {0, -50}, {0, 50}, {5, 50}, {5, -50}, {0, -50}},
				ports={{0, 1}, {2, 0}, {5, 1}, {7, 0},
