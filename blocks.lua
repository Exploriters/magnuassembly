...
--	Light Guard
...

	{
		ident=1238032,
		group=1238,
		features=PALETTE|LAUNCHER|THRUSTER|TORQUER,
...
replicateBlock=0,
...

	{
		...
		replicateBlock={
			group=1238,
			features=EXPLODE|FREERES|GENERATOR|LAUNCHER|NOCLIP|NOREGEN|SHIELD|THRUSTER|ONEUSE,
			...
			replicateBlock={
				group=1238,
				features=AUTOLAUNCH|EXPLODE|FREERES|NOCLIP|SHIELD|ONEUSE,
...

	{
		...
		replicateBlock={
			group=1238,
			features=EXPLODE|NOREGEN|THRUSTER|TORQUER,
