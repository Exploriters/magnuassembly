...
--			explodeRadius=1288490123265,
	...
	
	{
		1443000,
		group=1443,
		features=PALETTE|ASSEMBLER|CANNON_BOOST|COMMAND|FACTORY|GENERATOR|MELEE|TELEPORTER|THRUSTER|TRACTOR,
...

	{
		1443001,
		group=1443,
		features=PALETTE|ASSEMBLER|CANNON_BOOST|COMMAND|GENERATOR|MELEE|TELEPORTER|THRUSTER|TRACTOR,
		name="Rookie Capsule",
		shape=1257020,
		scale=2,
		fillColor=0x0984ff,
