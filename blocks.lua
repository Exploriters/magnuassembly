...
replicateBlock=0,
	...
	
	{
		ident=1242000,
		group=1242,
		features=ASSEMBLER|CANNON_BOOST|COMMAND|GENERATOR|SELFFACTORY|TORQUER|TRACTOR|TELEPORTER|PHOTOSYNTH,
...
replicateBlock=0,
...

	{
		ident=1242009,
		group=1242,
		features=PALETTE|LASER|MELEE|GENERATOR|PHOTOSYNTH|TURRET,
