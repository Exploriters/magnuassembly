	...
	
	{
		...
		name=_("_text_lapismDepshieldShield")_("_bl")_("_text_MkI"),
		shape=HEXAGON,
		scale=3,
		#include "_T_Lapishull.lua"
		growRate=inf,
	...
	
	{
		...
		group=1257,
		features=NOPALETTE|MELEE|NOCLIP|SHIELD|ONEUSE|INVISIBLE,
		name=_("_text_lapismDepshieldShield")_("_bl")_("_text_MkII"),
		shape=HEXAGON,
		scale=3,
		#include "_T_Lapishull.lua"
		growRate=inf,
	...
	
	{
		...
		group=1257,
		features=NOPALETTE|MELEE|NOCLIP|SHIELD|ONEUSE|INVISIBLE,
		name=_("_text_lapismDepshieldShield")_("_bl")_("_text_MkIII"),
		shape=HEXAGON,
		scale=3,
		#include "_T_Lapishull.lua"
		growRate=inf,
	...
	
	{
		...
		sort=1257209000,
		group=1257,
		features=NOPALETTE|ASSEMBLER|COMMAND|GENERATOR|INVISIBLE|SEED|ONEUSE|CANNON|ALWAYSFIRE|MELEE,
