...
replicateBlock=0,
		teleporterPower=-1e-16,
		teleporterRadius=3*4000,
	},
	...
	{ -- crystal
		...
		sort=1242009000,
		group=1242,
		features=PALETTE|LASER|MELEE|GENERATOR|PHOTOSYNTH|TRACTOR|TURRET|FACTORY|SHIELD|NOCLIP_ALLY,
	...
	
	{
		...
		sort=1242013000,
		group=1242,
		features=PALETTE|GENERATOR|ROOT|SHIELD,
	...
	--	features=PALETTE|TELEPORTER|NEVERFIRE|ONEUSE|CANNON_BOOST|ENVIRONMENTAL|NORECOLOR|MELEE|SHIELD,
		features=PALETTE|TELEPORTER|CANNON_BOOST|ENVIRONMENTAL|NORECOLOR|MELEE,
...

	{
		...
		sort=1242413000,
		group=1242,
		features=PALETTE|LASER|CANNON|TURRET,
