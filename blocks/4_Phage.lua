
	{
		...
		sort=1880000000,
		group=1880,
		features=ASSEMBLER|CANNON|COMMAND|MELEE|GENERATOR|SELFFACTORY|SHIELD|TELEPORTER|THRUSTER|TORQUER|TRACTOR|TURRET|FIN,
...

	{
		...
		sort=1880003000,
		group=1880,
		features=PALETTE|CANNON_BOOST|THRUSTER|FIN,
