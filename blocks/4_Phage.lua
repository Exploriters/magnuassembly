...

	{
		...
		sort=1880003000,
		group=1880,
		features=PALETTE|TELEPORTER|NEVERFIRE|ONEUSE|CANNON_BOOST|THRUSTER|0000000000,
...

	{
		...
		sort=1880006000,
		group=1880,
		features=PALETTE|TELEPORTER|NEVERFIRE|ONEUSE|CANNON_BOOST|MELEE|FACTORY|PHOTOSYNTH|TRACTOR|SHIELD|GENERATOR,
		deathFeatures=GROW,
...

	{
		...
		sort=1880007000,
		group=1880,
	--	features=PALETTE|TELEPORTER|NEVERFIRE|ONEUSE|ALWAYSFIRE|CANNON_BOOST|MELEE|LASER|GENERATOR,
		features=PALETTE|TELEPORTER|NEVERFIRE|ONEUSE|CANNON_BOOST|GENERATOR|THRUSTER|ROTATOR,
	...
	--	generatorCapacityPerSec=3100,
		...
		thrusterForce=8333.3333333333333333333333333333,
		thrusterBoost=8,
		thrusterBoostTime=0.05,
		thrusterColor=0xff7fff00,
		thrusterColor1=0xbfc0ff7f,
