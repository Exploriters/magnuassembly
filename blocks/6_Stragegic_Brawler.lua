	...
	--	growRate=0.1,
		...
		replicateBlock={
			group=1257,
			features=EXPLODE|FREERES|NOCLIP|NOREGEN,
			name=_("_text_3883tech")_("_bl")_("_text_3883BackuppowerSubsystem"),
			shape=1257026,
			scale=1,
			fillColor=0x0984ff,
		...
		launcherPower=-10000000,
		launcherOutSpeed=0,
		launcherAngVel=0,
		replicateTime=50,
		turretLimit=1e-16,
		shroud={
			{size={2, 1}, offset={-3.5, 0, 0.005}, taper=1, count=1, tri_color_id=2, tri_color1_id=2, line_color_id=2},
			{size={0.5, 0.5}, offset={-3, 0, 0.05}, taper=1, count=1, tri_color_id=0, tri_color1_id=1, line_color_id=2},
		},
	},
...

	{
		...
		sort=1443239000,
		group=1443,
		features=PALETTE|000000|THRUSTER|TORQUER|LAUNCHER|NEVERFIRE,
